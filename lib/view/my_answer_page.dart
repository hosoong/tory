...
class MyAnswerPage extends StatefulWidget {
  MyAnswerPage({Key? key}) : super(key: key);

  @override
  State<MyAnswerPage> createState() => _MyAnswerPageState();
}

class _MyAnswerPageState extends State<MyAnswerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('내 답변보기',style: headline2(color: text_on_color),),
        centerTitle: true,
